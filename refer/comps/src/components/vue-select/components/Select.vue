...
<div :dir="dir" class="v-select" :class="stateClasses">
        ...
        <div ref="selectedOptions" class="vs__selected-options">
            ...
            >
                <span :key="getOptionKey(option)" class="vs__selected">
                    ...
                    <button v-if="multiple" ref="deselectButtons" :disabled="disabled" type="button" class="vs__deselect" aria-label="Deselect option" @click="deselect(option)">
                        <ui-icon type="circle-close"></ui-icon>
                    </button>
                </span>
            </slot>
    ...
    <transition :name="transition">
        <ul v-if="dropdownOpen" ref="dropdownMenu" class="vs__dropdown-menu" role="listbox" @mousedown.prevent="onMousedown" @mouseup="onMouseUp">
            <li
            ...
            <li v-if="!filteredOptions.length" class="vs__no-options" @mousedown.stop="">
                <slot name="no-options">无匹配数据</slot>
            </li>
        </ul>
    </transition>
</div>
...
export default {
    ...
    props: {
       ...
       */
        ...
        /**
       * When true and the input is blur, Selector will select the value
       * @type {Boolean}
       */
        selectOnBlur: {
            type: Boolean,
       ...
       */
        onSearchBlur() {
            if (this.mousedown && !this.searching) {
                ...
                if (this.selectOnBlur && !this.isComposing) {
                    this.typeAheadSelect();
                }
    ...
    computed: {
            ...
            return {
                search: {
                    ...
                    events: {
                        ...
                        'input': (e) => this.search = e.target.value ? e.target.value.trim() : ''
                    }
                },
                spinner: {
       ...
       */
        filteredOptions() {
            ...
            if (this.taggable && this.search.length && !this.optionExists(this.search) && !this.searchNoCurr) {
