<template>
  <div ref="cropper" class="vue-cropper" @mouseout="cancleScale" @mouseover="scaleImg">
    <div class="cropper-box">
      ...
      >
        <img ref="cropperImg" alt="cropper-img" :src="imgs" />
      </div>
    </div>
    <div
    ...
    >
      ...
      <span v-if="info" class="crop-info" :style="{ top: cropInfo }">{{ this.cropW > 0 ? this.cropW : 0 }} × {{ this.cropH > 0 ? this.cropH : 0 }}</span>
      <span v-if="!fixedBox">
