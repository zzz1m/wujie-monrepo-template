<template>
  <div>
    <ui-dialog
      ...
      :title="title"
      width="400"
      wrap-class="ui-dialog-reset batch-import-dialog"
...
import { decrypt } from '@noah/tools/src/utils/crypto';
import SalaryUpload from './salary-upload.vue';
export default {
  props: {
    errorMessageType: {
      type: String,
