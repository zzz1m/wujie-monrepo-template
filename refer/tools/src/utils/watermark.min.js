...
let loadMark = function (settings) {
  var defaultSettings = {
    ...
    watermark_subhead_fontsize: '25px', // 二级文本字号
    ...
    watermark_even_distance_left: 0, // 水印偶数行X偏移量
    watermark_even_distance_top: 0 // 水印偶数行Y偏移量
  };
  ...
  //获取页面最大宽度
  var page_width = Math.max(document.body.scrollWidth, document.body.clientWidth) + defaultSettings.watermark_width;
  //获取页面最大长度
  var page_height = Math.max(document.body.scrollHeight, document.body.clientHeight, document.documentElement.clientHeight) + defaultSettings.watermark_height;
  ...
  if (
    ...
    defaultSettings.watermark_cols = parseInt(
      (page_width - defaultSettings.watermark_x + page_offsetLeft) / (defaultSettings.watermark_width + defaultSettings.watermark_x_space)
    );
  ...
  if (
    ...
    defaultSettings.watermark_rows = parseInt(
      (page_height - defaultSettings.watermark_y + page_offsetTop) / (defaultSettings.watermark_height + defaultSettings.watermark_y_space)
    );
  ...
  //动态添加样式表
  if (document.all) {
    window.style = '.water-mask {background-color:blue;';
    ...
    style.innerHTML =
      '' +
      '.water-mask span { display:block; line-height: 1; }' +
      '.water-mask span.sub {display:block; line-height: 0.8; font-size: ' +
      defaultSettings.watermark_subhead_fontsize +
      '; }' +
      '.water-mask1 { margin-left: ' +
      defaultSettings.watermark_even_distance_left +
      'px; margin-top: ' +
      defaultSettings.watermark_even_distance_top +
      'px; }' +
      '.water-mask { ' +
      'display: block;' +
      'position: fixed;' +
  ...
  for (var i = 0; i < defaultSettings.watermark_rows; i++) {
    ...
    for (var j = 0; j < defaultSettings.watermark_cols; j++) {
      ...
      // 设置水印相关属性start
      mask_div.className = 'water-mask' + ' ' + 'water-mask' + (i % 2);
