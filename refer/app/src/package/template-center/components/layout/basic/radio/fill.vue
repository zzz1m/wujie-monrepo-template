        ...
        <ui-radio-group :value="valueConfig[PARAM_COMMON_VALUE_CODE][PARAM_SELECT_OPTION_CODE]" @on-change="handleChange">
            ...
            >
                <div class="option-item-content">
                    ...
                    <ui-input v-if="item.hasExtra && (valueConfig[PARAM_COMMON_VALUE_CODE][PARAM_SELECT_OPTION_CODE] === item.code)" :value="valueConfig[PARAM_COMMON_VALUE_CODE][PARAM_SELECT_OPTION_INFORMATION_CODE]"
                        class="option-extra"
                        type="text" placeholder="请输入内容"
                        clearable
                        @input="(value) => handleInputChange(value, index)"
                    ></ui-input>
                </div>
                <!-- 选项说明 -->
