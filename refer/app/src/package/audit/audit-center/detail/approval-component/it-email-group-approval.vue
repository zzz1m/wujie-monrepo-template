...
<div class="it-approval-page it-password-approval">
    ...
    <div class="approval-component__container approval-no-border">
        ...
        >
            <ui-table-column show-overflow-tooltip prop="displayName" label="群组名称" min-width="100"></ui-table-column>
            <ui-table-column show-overflow-tooltip prop="mailNickname" label="群组地址" min-width="140">
                <template slot-scope="{row}">
                    <span>{{ row.mailNickname }}.g@kanzhun.com</span>
                </template>
            </ui-table-column>
            <ui-table-column show-overflow-tooltip prop="ownerName" label="负责人" min-width="60"></ui-table-column>
            <ui-table-column show-overflow-tooltip prop="allowExternalSenders" label="接受外部邮箱" min-width="60">
                <template slot-scope="{row}">
                    <span>{{ row.allowExternalSenders + '' === '1' ? '是' : '否' }}</span>
                </template>
            </ui-table-column>
...
export default {
    ...
    methods: {
        ...
        async getProgressInfo() {
            ...
            this.tableData = (root.detail || {}).mailGroupList || [];
        }
    }
};
</script>