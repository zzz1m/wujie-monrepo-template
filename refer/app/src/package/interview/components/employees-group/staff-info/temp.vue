...
import SelfField from '@/package/interview/components/employees-base/self-field/temp.vue';
import SystemField from '@/package/interview/components/employees-base/system-field/temp.vue';
