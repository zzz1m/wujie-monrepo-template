...
let loadMark = function(settings) {
    ...
    var page_height = Math.max(
        document.body.scrollHeight, document.body.clientHeight, document.documentElement.clientHeight) + defaultSettings.watermark_height;
    ...
    if (document.all) {
        ...
        style.innerHTML = '' 
            ...
            + '.water-mask span.sub {display:block; line-height: 0.8; font-size: ' + defaultSettings.watermark_subhead_fontsize + '; }' 
            + '.water-mask1 { margin-left: '+ defaultSettings.watermark_even_distance_left+'px; margin-top: '+ defaultSettings.watermark_even_distance_top+'px; }' 
            + '.water-mask { ' 
                + 'display: block;' 
                + 'position: fixed;' 
                + 'z-index: 9999;' 
