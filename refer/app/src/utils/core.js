...
const Core = function() {
    ...
    function getCompareFunction(comparator) {
        return isString(comparator) ?
            ...
            }: isFunction(comparator) ? comparator: isCash(comparator) ?
                function(i, ele) {
    ...
    function unique(arr) {
        return arr.length > 1 ? filter.call(arr,
    ...
    function getValue(ele) {
        if (ele.multiple) return pluck(filter.call(ele.options,
            function(option) {
